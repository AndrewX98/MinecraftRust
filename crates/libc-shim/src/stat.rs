...
pub unsafe extern "C" fn mkfifo(path: *const c_char, mode: u32) -> i32 { libc::mkfifo(path, mode as libc::mode_t) }
pub unsafe extern "C" fn mknod(path: *const c_char, mode: u32, dev: u64) -> i32 { libc::mknod(path, mode as libc::mode_t, dev as _) }
