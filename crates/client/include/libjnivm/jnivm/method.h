...
namespace jnivm {
    ...
    // Runtime dispatch for registered native functions.
    // Calls native function pointer with jvalue* array converted per signature.
    void CallRegisteredNative(JNIEnv* env, jobject obj, void* fn, const std::string& sig, const jvalue* values);
