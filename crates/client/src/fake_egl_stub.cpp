...
// --- linker_load_library wrapper for Rust ---
// Takes parallel arrays of (name, func_ptr) and forwards to the Rust linker.
// Phase 2: Rust-only — no C++ linker::load_library mirror.
